...
<head>
    ...
    <title>Aplikasi Bank Sampah Reksa Kepil | Admin</title>
                ...
                <div class="login-form">
                    <form action="{{route('admin.login')}}" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-12">
                              ...
                              <div class="input-group">
                                <select id="dynamic_select"  class="form-control" required>
                                    <option value="{{route('customer.login')}}">Nasabah</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' has-warning' : '' }}" value="{{ old('email') }}" placeholder="Alamat Email">
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-12">
                        ...
                        <button type="submit" class="btn social btn-success btn-flat m-b-30 m-t-30">Masuk </button>
