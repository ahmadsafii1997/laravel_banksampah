                                      ...
                                      <div class="row form-group">
                                          ...
                                          <div class="col-12 col-md-9">
                                            <form action="{{route('detailtransaction.store')}}" method="POST">
                                              ...
                                              @endforeach
                                              <button type="submit" class="btn btn-secondary pull-right"><i class="fa fa-plus"></i> Detail Transaksi</button>
                                            </form>
                                          </div>
                                      </div>
                                      ...
                                      <table class="table table-striped">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{$trans->id}}"><i class="fa fa-trash"></i></button>
                                            </td>
                                          </tr>
                                          @endforeach
                                        </tbody>
                                    ...
                                    <div class="tab-pane fade" id="custom-nav-contact" role="tabpanel" aria-labelledby="custom-nav-contact-tab">
                                      <table id="bootstrap-data-table" class="table table-striped">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                <td>{{ $i++ }}</td>
                                                <td>{{$trash->trashprice->name}}</td>
                                                <td><span class="badge badge-warning">Dihapus</span></td>
                                                <td>
                                                  <form method="POST" action="{{route('detailtransaction.restore', $trash->id)}}">
                                                    @csrf
