...
<main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Detail Transaksi xxx</li>
    </ol>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tambah Detail Transaksi</strong>
