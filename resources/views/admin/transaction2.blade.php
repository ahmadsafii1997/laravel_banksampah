                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="code" class="form-control" readonly>
                                        <option value="{{$trans->code}}" >{{$trans->code}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="customer_id" class="form-control" readonly>
                                        <option value="{{$trans->customer->id}}" >{{ ucfirst($trans->customer->name)}}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table" id="dynamicTable">
                                ...
                                <tbody>
                                    <tr>
                                          @foreach($transactions as $trans)
                                            <input type="hidden" name="addmore[0][transaction_id]" id="addmore[0][transaction_id]" value="{{ $trans->id }}">
                                          @endforeach
                                        <td>
